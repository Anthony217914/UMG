...
if (authError) {
  console.error("SUPABASE ERROR COMPLETO:", authError);
  setErrorMsg(authError.message || "Error desconocido al crear usuario");
  return;
}
  ...
  if (!userId) {
    setErrorMsg("No se pudo obtener el ID del usuario creado.");
    return;
  }
